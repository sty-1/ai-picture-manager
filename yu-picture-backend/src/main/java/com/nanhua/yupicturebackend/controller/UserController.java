...
import com.nanhua.yupicturebackend.model.dto.user.*;
import com.nanhua.yupicturebackend.model.entity.User;
import com.nanhua.yupicturebackend.model.vo.LoginUserVO;
...
public class UserController {
    ...
    public BaseResponse<Boolean> deleteUser(@RequestBody DeleteRequest deleteRequest) {
        ...
        ThrowUtils.throwIf(user == null, ErrorCode.NOT_FOUND_ERROR);
        // 逻辑删除前释放账号名，避免 UNIQUE KEY 冲突导致新用户无法注册同名账号
        User updateUser = new User();
        updateUser.setId(user.getId());
        updateUser.setUserAccount("deleted_" + System.currentTimeMillis() + "_" + user.getUserAccount());
    ...
    /**
     * 编辑个人信息（当前登录用户编辑自己的信息）
     */
    @PostMapping("/edit")
    public BaseResponse<Boolean> editProfile(@RequestBody UserEditRequest userEditRequest,
